    ...
    $.bonuses = {
            ...
            if (offset < total_count) {
                $(window).lazyLoad({
                    ...
                    load: function () {
                        ...
                        $.get(
                                url + '&lazy=1&offset=' + offset + '&total_count=' + total_count + '&' + $('#search').serialize(),
                                function (html) {
                                    var data = $('<div></div>').html(html);
                                    var children = data.find('#bonuses-list tbody').children();
                                    offset += count;
        ...
        initSearchHandler: function () {
            ...
            $('#search').submit(function () {
                self.load('?plugin=bonuses&action=bonuses&' + $(this).serialize(), function () {
                    $.bonuses.initButtons();
                    $.bonuses.selectAllInit();
                    $.bonuses.initSearchHandler();
                });
